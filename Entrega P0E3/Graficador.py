# -*- coding: utf-8 -*-
"""
Created on Wed Aug 18 14:13:41 2021

@author: diego
"""
#Crear gráfico y su formato
...
def graficar(Ns, dt_s, mem_s, libreria, dtype):
    ...
    plt.figure(1)
    plt.subplot(2,1,1)
    plt.title("Rendimiento Inversa"+" "+ str(libreria)+" "+str(dtype))
    ...
    plt.grid(True)
    plt.savefig("Rendimiento Inversa" + " " + str(libreria) +" "+ str(dtype) +".jpg")
